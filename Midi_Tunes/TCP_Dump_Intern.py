...
def main():
    ...
    while line:
		...
		note  = MAX_OCTAVE
            ...
            track.append(midi.NoteOnEvent(tick=100, velocity=127, pitch=16))
            track.append(midi.NoteOffEvent(tick=370, pitch=16))
	    track.append(midi.ProgramChangeEvent(data=[114]))

	    track2.append(midi.NoteOnEvent(tick=0, velocity=127,pitch=20))
            track2.append(midi.NoteOffEvent(tick=1410, pitch=20))
	    track2.append(midi.ProgramChangeEvent(data=[114]))
